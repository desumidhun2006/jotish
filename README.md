...
-   **Zero UI Libraries:** All components and styling were built from scratch using Tailwind CSS. No component libraries like MUI or Ant Design were used.
...
3.  **Calculating the View:** On every scroll event, we capture the `scrollTop` value. We use this to calculate which items should be visible:
